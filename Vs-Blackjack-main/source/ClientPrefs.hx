...
class ClientPrefs {
	...
	public static var oldnotes:Bool = false;
	...
	public static var healthdrain:Float = 47.5;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.oldnotes = oldnotes;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.oldnotes != null) { // oldnotes
			oldnotes = FlxG.save.data.oldnotes;
		}
		if(FlxG.save.data.healthdrain != null) { // HealthDrain
